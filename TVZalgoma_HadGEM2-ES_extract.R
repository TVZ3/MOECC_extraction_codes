...
for (i in 1:12)
{
  col1 <- paste("he26tmean50",i, sep="")
  x10[,col1] <- NA
}
for (i in 1:12)
{
  col2 <- paste("he45tmean50",i, sep="")
  x10[,col2] <- NA
}
for (i in 1:12)
{
  col3 <- paste("he60tmean50",i, sep="")
  x10[,col3] <- NA
}
for (i in 1:12)
{
  col4 <- paste("he85tmean50",i, sep="")
  x10[,col4] <- NA
}
names(x10)
...
for (i in 1:12)
{
  col1 <- paste("he26tmean70",i, sep="")
  x10[,col1] <- NA
}
for (i in 1:12)
{
  col2 <- paste("he45tmean70",i, sep="")
  x10[,col2] <- NA
}
for (i in 1:12)
{
  col3 <- paste("he60tmean70",i, sep="")
  x10[,col3] <- NA
}
for (i in 1:12)
{
  col4 <- paste("he85tmean70",i, sep="")
  x10[,col4] <- NA
}
names(x10)
x11 <- x10[, c(1:36, 145:156, 37:72, 157:168, 73:108, 169:180, 109:144, 181:192)]
