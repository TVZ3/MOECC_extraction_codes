...
for (i in 1:12)
{
  col1 <- paste("gf26tmean50",i, sep="")
  x10[,col1] <- NA
}
for (i in 1:12)
{
  col2 <- paste("gf45tmean50",i, sep="")
  x10[,col2] <- NA
}
for (i in 1:12)
{
  col4 <- paste("gf85tmean50",i, sep="")
  x10[,col4] <- NA
}
names(x10)
...
for (i in 1:12)
{
  col1 <- paste("gf26tmean70",i, sep="")
  x10[,col1] <- NA
}
for (i in 1:12)
{
  col2 <- paste("gf45tmean70",i, sep="")
  x10[,col2] <- NA
}
for (i in 1:12)
{
  col4 <- paste("gf85tmean70",i, sep="")
  x10[,col4] <- NA
}
names(x10)
x11 <- x10[, c(1:36, 109:120, 37:72, 121:132,  73:108,  133:144)]
